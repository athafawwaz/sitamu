...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    date: "2026-05-16",
    type: "patch",
    description: "Update Privacy & Consent Modal content in KioskPengantaran to match official document"
  },
  {
    version: "1.16.3",
    date: "2026-05-13",
  ...
  },
  {
    ...
    date: "2026-05-13",
    type: "patch",
    description: "Fix capitalization in MasterTknoView and update backend prompt template for Go/Fiber"
  },
  {
    version: "1.16.0",
    date: "2026-05-13",
  ...
  },
  {
    ...
    date: "2026-05-08",
    type: "patch",
    description: "Fix Shield ReferenceError in Login page and finalize Pusri logo branding across all headers"
  },
  {
    version: "1.15.4",
    date: "2026-05-08",
    type: "patch",
    description: "Replace application logo with Pusri emblem across Login, Sidebar, and Mobile Header"
  },
  {
    version: "1.15.3",
    date: "2026-05-08",
